...
public class SD07_followUs_StepDef {
    ...
    public void userShouldBeRedirectedToTheFacebookPage(String expUrl) throws InterruptedException {
    ...
    public void userShouldBeRedirectedToTheTwitterPage(String expUrl) {
        ...
        String actualRes =  driver.switchTo().window(arrayList.get(1)).getCurrentUrl();
    ...
    public void userShouldBeRedirectedToTheCorrectRSSFeed(String expUrl) {
        ArrayList<String> arrayList = new ArrayList<>(driver.getWindowHandles());
        String  expectRes = "https://demo.nopcommerce.com/news/rss/1";
        String actuRes =  driver.switchTo().window(arrayList.get(1)).getCurrentUrl();
        Assert.assertEquals(actuRes, expectRes);
    }
